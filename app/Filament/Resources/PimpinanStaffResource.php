        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('status')
                    ->options([
                        'Kepala Program Studi Kimia' => 'Kepala Program Studi Kimia',
                        'Dosen' => 'Dosen',
                        'Staff' => 'Staff',
                    ])
                    ->reactive()
                ...
                ->visible(fn (Get $get) => $get('status') === 'Kepala Program Studi Kimia') 
                ->required(fn (Get $get): bool => $get('status') === 'Kepala Program Studi Kimia')
                ->columnSpanFull(),
            ]);
    }
