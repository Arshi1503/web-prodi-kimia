...
<html class="no-js" lang="en">
    ...
    <body class="loading" data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="#252840">
        @php
        $isHome = Request::is('/');
        @endphp
        <div id="preloader" class="tw-fixed tw-inset-0 tw-bg-white tw-z-50 tw-flex tw-items-center tw-justify-center">
            <svg class="tw-w-12 tw-h-12 tw-text-[#89b4f9] tw-animate-spin" viewBox="0 0 64 64" fill="none"
             ...
             stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" class="tw-text-[#3b82f6]">
            </path>
        </svg>
        </div>
        <main>
